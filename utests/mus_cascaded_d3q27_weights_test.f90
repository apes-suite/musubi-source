...
program mus_cascaded_d3q27_weights_test
  ...
  use mus_compute_cumulant_module,      only: cascaded_d3q27
  ...
  call tem_start('Cascaded D3Q27 optimized kernel weights utest', 'utest', params%general)
  error = .true.
  ...
  scheme%header%relaxation = 'cascaded'
  ...
  call cascaded_d3q27( fieldProp = scheme%field(:)%fieldProp, &
    &                  inState   = inState,                   &
    &                  outState  = outState,                  &
    &                  auxField  = auxField,                  &
    &                  neigh     = neigh,                     &
...
end program mus_cascaded_d3q27_weights_test
!******************************************************************************
