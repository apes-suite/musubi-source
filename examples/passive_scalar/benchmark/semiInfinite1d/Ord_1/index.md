title: Advection-diffusion-reaction benchmark: Semi-infinite 1D domain with 1st order accuracy source

# Advection-diffusion-reaction benchmark: Semi-infinite 1D domain with 1st order accuracy source ## {#ex_semi_infinite_1d_ord1}
...
With a reaction term $R(C)$, the 1st order accuracy source term is given by
$$
  S_i = w_i R(C)
$$
